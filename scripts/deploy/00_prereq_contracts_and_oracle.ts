...
const main = async ({
  ...
  // const gammaControllerDeployment = (await ethers.getContractFactory("Controller")).attach(gammaController.address);
  ...
  // await gammaControllerDeployment.initialize(addressBook.address, deployer);
};
main.tags = ["PreReqContracts"];
